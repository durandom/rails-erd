...
module RailsERD
  ...
  class Diagram
    ...
    def generate
      ...
      if options.only_models_include_depth.present?
        depth = options.only_models_include_depth.to_i
    ...
    def recurse_into_relationships(entity, max_level, current_level = 0)
      ...
      relationships = entity.relationships.reject(&:recursive?)
      relationships = relationships.reject(&:indirect?)
